...
nombres <- c("Guaymas", "San Luis Río Colorado", "Empalme", "Caborca")
agebs <- capa_ageb@data
agebs <- agebs %>% filter (NOM_MUN %in% nombres)
write.csv(agebs, "agebs.csv", fileEncoding = "latin1")
